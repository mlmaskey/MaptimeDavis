...
* Common package in R for interative map is mapview. 
     * This  package has efficient functions to create and visualize the map in html. For detail, refer to:
     https://cran.r-project.org/web/packages/mapview/readme/README.html
